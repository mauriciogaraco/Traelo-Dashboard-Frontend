...
import { CommissionType, type BusinessDTO } from '@/lib/types';
import { useUpdateBusinessMutation } from './businessesApi';
...
export function EditBusinessModal({ business, onClose }: EditBusinessModalProps) {
